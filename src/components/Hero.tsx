      ...
      >
        <div className="text-center space-y-4 sm:space-y-6 max-w-xl leading-relaxed">
          ...
          <p className="text-base sm:text-lg lg:text-xl leading-relaxed mb-4">
            ...
            {new Date().getFullYear() - dateOfCareerStart.getFullYear()} years of experience in
            designing and implementing RESTful APIs, integrating third-party services and ensuring
            adherence to coding standards. Strong knowledge of data engineering, including data
            pipeline design, ETL processes and working with databases for scalable data solutions.
          </p>
          <p className="text-base sm:text-lg lg:text-xl leading-relaxed mb-4">
            Proficient in containerization technologies, CI/CD pipelines, version control systems
            and data engineering workflows. Experienced in working with relational and NoSQL
            databases, optimizing queries and handling large-scale data processing.
          </p>

          <p className="text-base sm:text-lg lg:text-xl leading-relaxed mb-4">
            Possesses a strong background in software development, with a Master&apos;s degree in
