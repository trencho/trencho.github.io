...
const Contact = () => {
  ...
  return (
    <motion.section
      className={`p-6 sm:p-8 md:p-10 lg:p-16 rounded-xl shadow-lg max-w-4xl mx-auto my-8 md:my-12 ${
    ...
    >
      ...
      <motion.p
        className={`text-base sm:text-lg lg:text-xl text-center mb-8 sm:mb-10 p-4 rounded-lg ${
          darkMode ? "bg-[#444444] text-white" : "bg-gray-50 text-gray-600"
        }`}
        variants={fadeInUp}
      >
        ...
        <a
          ...
          className={`${
            darkMode ? "text-teal-300" : "text-purple-700"
          } font-semibold`}
        >
      ...
      {showMessage && (
        <motion.div
          className={`text-center p-4 sm:p-6 rounded-lg shadow-md max-w-md mx-auto flex items-center justify-center ${
            darkMode
      ...
      {!submitted && (
        <motion.form
          ...
          className={`max-w-lg w-full p-6 sm:p-8 rounded-lg shadow-md mx-auto ${
            darkMode ? "bg-[#374151] text-white" : "bg-white"
          }`}
          initial="hidden"
          animate="visible"
          variants={fadeInUp}
        >
          ...
          <motion.button
            type="submit"
            className={`px-6 py-3 rounded-full font-semibold transition flex items-center justify-center space-x-2 ${
              darkMode
